      ...
      >
        <div className="relative w-full mx-0 h-[60vh] lg:h-[420px]">
          <Image
            width={1636}
            height={1093}
            src="/images/offers/fourthOffer.webp"
            alt="Your Image"
          ...
          <div className="absolute p-2 px-16 bg-white/60 bottom-0 left-1/2 transform -translate-x-1/2 ">
            ...
            <p className="text-sm">
              Detailed Modular Interiors & Makeovers for a 4 Bhk Residence
            </p>
            ...
            <div className="flex flex-col lg:flex-row justify-around px-8 pb-8 sm:gap-8">
              <div className="lg:w-1/2 lg:pr-4 sm:p-4 text-left ">
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    Shoe rack/With Sitting – 1400*900 mm with Louverts
                  </p>
                  <p>Wall Panelling Exclusive – 2340*2340 mm Fluted Designs</p>
                  <p>Glass Works in Entrance</p>
                  <p>
                    Shutter in German Designer Membrane. Thick 25mm shutters
                    with 1.8 mm covering sheets.
                  </p>
                </div>
                <div className="mb-4">
                  <h2 className="text-md font-semibold mb-1">LIVING ROOM</h2>
                  <p className="text-sm">
                    LCD unit with Storage & Lights with shutter in slim lacquer
                    glass profile with choice of Glass – 2100*2000 mm
                  </p>
                  <p>Mini Bar Unit 900 * 600 mm – Custom</p>
                  <p>
                    Shutter in German Designer Membrane or equivalent. Thick
                    25mm shutters with 1.8 mm covering sheets.
                  </p>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    Dining table with 6 seater – 2100*1200 mm
                  </p>
                  <p>Dining chair in Teak (6 Nos)</p>
                  <p>Dining Area Cabinets – 2800 mm by 720 mm</p>
                  <p>
                    Shutter in German Membrane or equivalent. Thick 25mm
                    shutters with 1.8 mm covering sheets.
                  </p>
                </div>
                <div className="mb-4">
                  <h2 className="text-md font-semibold mb-1">
                  ...
                  <p className="text-sm">
                    3 Bathroom Vanities in LTW Materials – ( L 900 * W 720 mm )
                  </p>
                  <p>Mirror Storage in Bathroom with Lights – 1200 by 650 mm</p>
                  <p>
                    Shutter in German Membrane. Thick 25mm shutters with 1.8 mm
                    covering sheets.
                  </p>
                </div>
              </div>
              <div className="lg:w-1/2 lg:pl-4 sm:p-4 text-left ">
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    4 door Sliding wardrobe with End to End Shutters in Lacquer
                    Glass with soft close & 9 mm BP, depth 710 mm.
                  </p>
                  <p>
                    6 drawers, and handles in black matt/ or equivalent in
                    slimline russian with end to end sensor lights.
                  </p>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    2 door sliding wardrobe with loft with Italian fittings &
                    with 4 drawers and long handles in multi choice of profile
                    handles or long handles, with 9 mm BP & Lights .
                  </p>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    2 door Sliding Wardrobe with soft close and 3 drawers with
                    locker provisions and locks. With 9mm BP & Long Profiles
                    handles & Lights .
                  </p>
                ...
                <div className="mb-4">
                  <h2 className="text-md font-semibold mb-1">
                    MODULAR KITCHEN WITH Stylus Taiwan Top Models Legra MAKE or
                    Equivalent
                  </h2>
                  ...
                  <p>
                    Imported accessories – 9 drawers, Bowl Cutlery tray, BPO,
                    Dish Rack, Dustbin, Detergent holder, Wicker basket, Pantry
                    Glass With Hydraulic, Corner Fitting with Complete Lights,
                    Japanese handless profiles. ( Fittings of Blum/Hafele
                    Austrian/Germany/Stylus or Equivalent )
                  </p>
                  <p>Hob Chimney Included, Countertop Quartz Included.</p>
                  <p>
                    Shutter in Premium Membrane Finish. Thick 25mm shutters with
                    1.4 mm covering sheets. With 2-3 Glass Shutters on either
                    side.
                  </p>
                </div>
              </div>
