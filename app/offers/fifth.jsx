      ...
      >
        <div className="relative w-full mx-0 h-[60vh] lg:h-[420px]">
          <Image
            width={1636}
            height={1093}
            src="/images/offers/fifthOffer.webp"
            alt="Your Image"
            ...
            <div className="flex flex-col lg:flex-row justify-around px-8 pb-8 sm:gap-8">
              <div className="lg:w-1/2 lg:pr-4 sm:p-4 text-left ">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    ...
                    glass profile with choice of Glass – 3500*2400 mm
                  </p>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    3 door Sliding Wardrobe with double soft close and 3 drawers
                    with locker provisions and locks with complete lights. With
                    9mm BP & Long Profiles handles.
                  </p>
                  ...
                  <p>
                    Shutter in German Fluted Materials. Thick 22mm shutters with
                    1.8 mm covering sheets with 1.8 mm EB.
                  </p>
                </div>
              </div>
              <div className="lg:w-1/2 lg:pl-4 sm:p-4 text-left ">
                <div className="mb-4">
                  ...
                  <p>
                    Shutter in German Fluted Materials or Lacquer Glass. Thick
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm">
                    3 door sliding wardrobe with loft with Italian fittings,
